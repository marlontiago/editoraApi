...
class CidadeController extends Controller
{
     ...
     * GET /api/admin/cidades/por-uf/SP?with_occupancy=1
     */
    ...
    /**
     * GET /api/admin/cidades/search?q=Curit&uf=PR&with_occupancy=1&limit=50
     */
    public function search(Request $request)
    {
        ...
        if ($q !== '')  $query->where('name', 'ILIKE', "%{$q}%"); // Postgres
