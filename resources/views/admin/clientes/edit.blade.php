    ...
    <div class="max-w-6xl mx-auto p-6">
        ...
        <form action="{{ route('admin.clientes.update', $cliente) }}" method="POST"
            ...
            <div class="col-span-12 md:col-span-8">
                ...
                <input type="text" id="razao_social" name="razao_social" value="{{ old('razao_social', $cliente->razao_social) }}"
            ...
            <div class="col-span-12 md:col-span-4">
                ...
                <input type="text" id="cnpj" name="cnpj" value="{{ old('cnpj', $cliente->cnpj) }}" maxlength="18"
            ...
            <div class="col-span-12 md:col-span-4">
                ...
                <input type="text" id="cpf" name="cpf" value="{{ old('cpf', $cliente->cpf) }}" maxlength="14"
            ...
            <div class="col-span-12 md:col-span-4">
                ...
                <input type="text" id="inscr_estadual" name="inscr_estadual" value="{{ old('inscr_estadual', $cliente->inscr_estadual) }}"
                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                @error('inscr_estadual') <p class="mt-1 text-xs text-red-600">{{ $message }}</p> @enderror
            </div>

            {{-- Telefones (lista com fallback do legado) --}}
            @php
                $telsInit = old('telefones');
                if ($telsInit === null) {
                    $telsInit = $cliente->telefones ?: [];
                    if (empty($telsInit) && !empty($cliente->telefone)) $telsInit = [$cliente->telefone];
                }
            ...
            {{-- E-mails (lista) com fallback do legado principal como adicional? (mantemos só adicionais) --}}
            @php
                $emailsInit = old('emails');
                if ($emailsInit === null) {
                    $emailsInit = $cliente->emails ?: [];
                }
            ...
            <div class="col-span-12 md:col-span-2">
                ...
                <input type="text" id="cep" name="cep" value="{{ old('cep', $cliente->cep) }}" maxlength="9"
            ...
            <div class="col-span-12 md:col-span-6">
                ...
                <input type="text" id="endereco2" name="endereco2" value="{{ old('endereco2', $cliente->endereco2) }}"
                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
            ...
            <div class="col-span-12 md:col-span-3">
                ...
                <input type="text" id="numero2" name="numero2" value="{{ old('numero2', $cliente->numero2) }}"
                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
            ...
            <div class="col-span-12 md:col-span-3">
                ...
                <input type="text" id="complemento2" name="complemento2" value="{{ old('complemento2', $cliente->complemento2) }}"
                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
            ...
            <div class="col-span-12 md:col-span-4">
                ...
                <input type="text" id="bairro2" name="bairro2" value="{{ old('bairro2', $cliente->bairro2) }}"
                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
            ...
            <div class="col-span-12 md:col-span-5">
                ...
                <input type="text" id="cidade2" name="cidade2" value="{{ old('cidade2', $cliente->cidade2) }}"
                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
            ...
            <div class="col-span-12 md:col-span-1">
                ...
                <select id="uf2" name="uf2"
                    ...
                    <option value="">--</option>
                    @foreach($ufs as $uf)
                        <option value="{{ $uf }}" @selected(old('uf2', $cliente->uf2) === $uf)>{{ $uf }}</option>
                    @endforeach
                </select>
            ...
            <div class="col-span-12 md:col-span-2">
                ...
                <input type="text" id="cep2" name="cep2" value="{{ old('cep2', $cliente->cep2) }}" maxlength="9"
                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="00000-000">
