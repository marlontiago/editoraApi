        ...
        <form action="{{ route('admin.clientes.store') }}" method="POST" class="space-y-6 bg-white p-6 rounded shadow">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                    ...
                    <input type="text" name="cnpj" id="cnpj" value="{{ old('cnpj') }}" maxlength="14" minlength="14" placeholder="00.000.000/0000-00" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                    @error('cnpj') <span class="text-red-600 text-sm">{{ $message }}</span> @enderror
                </div>
                <div>
                    <label for="cpf" class="block text-sm font-medium text-gray-700">CPF</label>
                    <input type="text" name="cpf" id="cpf" value="{{ old('cpf') }}" maxlength="11" minlength="11" placeholder="000.000.000-00" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                ...
                <div>
                    ...
                    <input type="text" name="inscr_estadual" id="inscr_estadual" value="{{ old('inscr_estadual') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="endereco" id="endereco" value="{{ old('endereco') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                    @error('endereco') <span class="text-red-600 text-sm">{{ $message }}</span> @enderror
                </div>
                <div>
                    <label for="numero" class="block text-sm font-medium text-gray-700">Número</label>
                    <input type="text" name="numero" id="numero" value="{{ old('numero') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                    ...
                    <input type="text" name="complemento" id="complemento" value="{{ old('complemento') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                    @error('complemento') <span class="text-red-600 text-sm">{{ $message }}</span> @enderror
                </div>
                <div>
                    <label for="bairro" class="block text-sm font-medium text-gray-700">Bairro</label>
                    <input type="text" name="bairro" id="bairro" value="{{ old('bairro') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                    @error('bairro') <span class="text-red-600 text-sm">{{ $message }}</span> @enderror
                </div>
                <div>
                    <label for="cidade" class="block text-sm font-medium text-gray-700">Cidade</label>
                    <input type="text" name="cidade" id="cidade" value="{{ old('cidade') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                    ...
                    <input type="text" name="uf" id="uf" value="{{ old('uf') }}" maxlength="2" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm uppercase">
                    @error('uf') <span class="text-red-600 text-sm">{{ $message }}</span> @enderror
                </div>
                <div>
                    <label for="cep" class="block text-sm font-medium text-gray-700">CEP</label>
                    <input type="text" name="cep" id="cep" value="{{ old('cep') }}" maxlength="8" minlength="8" placeholder="00000-000" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                    @error('cep') <span class="text-red-600 text-sm">{{ $message }}</span> @enderror
                </div>
                <div class="flex items-end">
                    <button type="submit" class="w-full md:w-auto px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700">Salvar</button>
                </div>
            </div>
        </form>
    </div>
