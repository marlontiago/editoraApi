<x-app-layout>
    <x-slot name="header"><h2 class="text-2xl font-bold">Novo Advogado</h2></x-slot>

    <div class="p-6 max-w-4xl mx-auto">
        <form action="{{ route('admin.advogados.store') }}" method="POST" class="bg-white border rounded p-6 space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="oab" class="w-full border rounded px-3 py-2" value="{{ old('oab') }}" required>
                </div>
