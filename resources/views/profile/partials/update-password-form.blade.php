<section>
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            {{ __('Para garantir a segurança da sua conta, utilize uma senha longa e aleatória. Ao excluir a conta, todos os seus recursos e dados serão apagados permanentemente. Digite sua senha para confirmar que deseja excluir sua conta permanentemente.') }}
        </p>
    </header>
